...
The goal of scan.tools is to improves workflow with using [S::Can spectro::lyser UV V2](https://www.s-can.at/products/spectrometer-probes)'s default analyte output data format

## Installation

You can install the released version of scan.tools from [Github.com/BrianY-Wang](https://github.com/BrianY-Wang/scan.Tools) with:
...
- Raw_data folder containing example unprocessed data output by the spectrolyzers 
