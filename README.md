...
-   This README file (.Rmd and .md)
-   DESCRIPTION file containing scan.Tools package description
-   NAMESPACE file containing scan.Tools package dependent libraries
-   roxygen R/ folder containing function source script (.R)
-   roxygen man/ folder containing package function documentation
-   roxygen tests/ folder containing testing script for package function
-   Raw\_data folder containing example unprocessed data output by the
    spectrolyzers
