...
test_NumberofColumns <- test_that("Testing if the output tibble has the right number of columns", {
  expect_length(import("/Users/brianwang/Desktop/EcoHydro/R/scan.tools/Raw_data/09210160.par","09210160"), 6)})

# Test 2 on spec2 output dataset
spec2 <- import("/Users/brianwang/Desktop/EcoHydro/R/scan.tools/Raw_data/09210160.par","09210160")
